...
export default function Footer() {
  return (
    <footer
      className="bg-main-black text-main-white px-20 pt-20 flex flex-col gap-14"
    >
      {/* Footer Wrapper */}
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:gap-20">
        ...
        <Image src={logo} alt="Brand Logo" width={124} height={52} />
          <p className="text-[13.5px] leading-[1.9] text-[#b0b0b0] mb-6">
            مجموعة سعودية متكاملة تقدم حلولاً احترافية في 5 قطاعات حيوية تخدم
            رؤية 2030
          </p>
          <div className="flex gap-2">
            <button
              className="w-9 h-9 rounded-md flex items-center justify-center text-white cursor-pointer transition-opacity hover:opacity-80 bg-[#1da1f2]"
              aria-label="Twitter"
            >
              <TwitterIcon />
            </button>
            <button
              className="w-9 h-9 rounded-md flex items-center justify-center text-white cursor-pointer transition-opacity hover:opacity-80 bg-[#1877f2]"
              aria-label="Facebook"
            >
              <FacebookIcon />
            </button>
            <button
              className="w-9 h-9 rounded-md flex items-center justify-center text-white cursor-pointer transition-opacity hover:opacity-80 bg-[#0a66c2]"
              aria-label="LinkedIn"
            >
              <LinkedInIcon />
            </button>
