...
import begoupBGBgWhite from "@/assets/begroup2.png";
...
export default function Solutions({ className }: { className?: string }) {
  ...
  return (
    <section className={`${isWhiteBg ? "bg-white" : "bg-secondary-black"} py-14 lg:py-0 lg:h-140 flex flex-col items-center justify-center relative overflow-hidden ${className || ""}`}>
      <Image
        src={isWhiteBg ? begoupBGBgWhite : begoupBG}
        alt="Solutions"
        width={4000}
      ...
      <div className="section-container w-full h-full relative flex flex-col gap-8 lg:gap-8 items-center justify-center">
        <div className="flex items-center justify-center flex-col gap-6 lg:gap-10">
          ...
          <p className={`font-normal text-base md:text-lg lg:text-xl ${isWhiteBg ? "text-main-black" : "text-main-white"} leading-relaxed lg:leading-[32.5px] lg:max-w-3xl text-center`}>
