...
const BLOGS_DATA = [
  {
    id: 1,
    image: blogImage,
    title: { ar: "كيف تبني استراتيجية رقمية ناجحة لعملك؟", en: "How to Build a Successful Digital Strategy for Your Business?" },
    description: {
  ...
  },
  {
    id: 2,
    image: image1,
    title: { ar: "أهمية الاستشارات الإدارية في تطوير المؤسسات", en: "The Importance of Management Consulting in Institutional Development" },
    description: {
      ...
      en: "Management consulting plays a pivotal role in helping organizations identify strengths and weaknesses and develop comprehensive improvement plans that ensure sustainability and growth.",
    },
    href: "/blogs/2",
  },
  {
    id: 3,
    image: slide1,
    title: { ar: "تطوير الكوادر البشرية: الاستثمار الأهم في عصرنا", en: "Human Capital Development: The Most Important Investment of Our Era" },
    description: {
  ...
  },
  {
    id: 4,
    image: image2,
    title: { ar: "إدارة المشاريع الاحترافية: مفاتيح النجاح والتميز", en: "Professional Project Management: Keys to Success and Excellence" },
    description: {
      ...
      en: "Successful project management relies on a comprehensive methodology that includes careful planning, role distribution, and continuous follow-up to ensure the desired results are achieved.",
    },
    href: "/blogs/4",
  },
  {
    id: 5,
    image: slide2,
    title: { ar: "رؤية 2030 وأثرها على بيئة الأعمال السعودية", en: "Vision 2030 and Its Impact on the Saudi Business Environment" },
    description: {
      ar: "تُعدّ رؤية المملكة 2030 محركًا رئيسيًا للتحول الاقتصادي، إذ تفتح آفاقًا واسعة أمام القطاع الخاص وتُرسي بيئة أعمال تنافسية ومتطورة.",
      en: "Saudi Vision 2030 is a key driver of economic transformation, opening wide horizons for the private sector and establishing a competitive and advanced business environment.",
    },
    href: "/blogs/5",
  },
  {
    id: 6,
    image: slide3,
    title: { ar: "التحول الرقمي في قطاع الموارد البشرية", en: "Digital Transformation in the Human Resources Sector" },
    description: {
      ...
      en: "The human resources sector is witnessing rapid digital transformation relying on artificial intelligence and data analytics to improve hiring decisions and develop competencies.",
    },
    href: "/blogs/6",
  },
];
...
function BlogCard({ image, title, description, href, locale }: BlogCardProps) {
  ...
  return (
    <section className="section-container bg-main-white">
      ...
      >
        ...
        <p className="text-main-black font-bold text-xl sm:text-2xl lg:text-[32px] leading-[160%] max-w-2xl">
          {locale === "ar"
