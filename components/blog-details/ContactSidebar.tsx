  ...
  return (
    <aside className="w-full lg:w-[412px] shrink-0">
      <div className="sticky top-24 flex flex-col gap-4">
        ...
        <div >
          <h3 className="text-primary font-bold text-[18px] leading-[160%] tracking-normal mb-1">
            {isAr ? "تواصل معنا" : "Contact Us"}
          </h3>
          <p className="text-[16px] font-normal leading-[30px] text-[#808080]">
            {isAr
        ...
        {/* Card */}
        <div className="bg-main-white rounded-lg py-[41px] px-4 flex flex-col gap-4 shadow-[0_12px_24px_rgba(3,45,96,0.04)]">

  {/* Header */}
  <div
    className="flex items-center justify-start pb-4 border-b border-[#E5E7EB] gap-[10px]"
  ...
  >
    ...
    <div className="flex flex-col">
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-[#032D60] font-extrabold text-[16px] leading-6 text-center">
          Be Group
        </span>
  ...
  >
    <div className="flex flex-col gap-3">
      ...
      <input
        ...
        type="text"
        placeholder={isAr ? "اكتب الاسم الأول هنا" : "Enter your first name"}
        {...register("firstName")}
        className={`w-full h-12 bg-transparent border rounded-[6px] px-4 text-main-black text-sm font-normal placeholder:text-[#B0B0B0] focus:outline-none transition-all ${
          errors.firstName
            ? "border-red-500"
    ...
    <div className="flex flex-col gap-3" ref={dropdownRef}>
      ...
      <div className="relative">
        <div 
          ...
          className={`w-full h-12 bg-transparent border rounded-[6px] px-4 text-main-black text-sm font-normal placeholder:text-[#B0B0B0] flex items-center justify-between cursor-pointer ${
            errors.serviceType
              ? "border-red-500"
              : "border-[#E5E7EB]"
          }`}
        >
          <span className={`text-sm ${selectedService ? "text-main-black" : "text-[#B0B0B0]"}`}>
            {selectedService
    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="relative">
        <input
          ...
          {...register("email")}
          className={`w-full h-12 bg-transparent border rounded-[6px] px-8 text-main-black text-sm font-normal placeholder:text-[#B0B0B0] focus:outline-none transition-all ${
            errors.email
              ? "border-red-500"
        ...
        <div className="absolute top-1/2 -translate-y-1/2 start-3 text-gray-400 pointer-events-none">
          <Mail size={16} />
        </div>
      </div>
...
<textarea
  ...
  {...register("message")}
  className={`w-full h-[144px] mb-6 bg-transparent border rounded-[2px] p-4 text-main-black text-sm font-normal placeholder:text-[#B0B0B0] focus:outline-none resize-none ${
    errors.message
      ? "border-red-500"
      : "border-[#EBEBEB] focus:border-primary"
  }`}
/>
  ...
  iconEnd={isAr ? <ArrowLeft size={18} /> : <ArrowRight size={18} />}
  className={`h-12 w-full justify-center rounded-[4px] font-medium text-[18px] leading-6 ${
