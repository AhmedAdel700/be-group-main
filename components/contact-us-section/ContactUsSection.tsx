                  ...
                  <input
                    ...
                    className={`w-full h-14 bg-transparent border rounded-xl px-4 text-main-black text-base leading-6.5 font-normal placeholder:text-labels focus:outline-none transition-all ${
                      errors.name
                        ...
                        : "border-secondary-black/10 focus:border-primary"
                    }`}
                  />
                  {errors.name && (
                    <span className="text-red-500 text-sm px-2 text-start">
                      {errors.name.message}
                    </span>
                  )}
                </div>
                      ...
                      className={`w-full h-14 bg-transparent border rounded-xl px-4 flex items-center justify-between cursor-pointer transition-all ${
                        errors.sector
                          ...
                          : isOpen
                            ...
                            : "border-secondary-black/10 hover:border-primary/40"
                      }`}
                    >
                      <span
                        className={`text-base leading-6.5 font-normal ${selectedOption ? "text-main-black" : "text-labels"}`}
                      >
                        {selectedOption
